    ...
    internal static class OverlayStyleBuilder
    {
        ...
        internal static string BuildInteractionCss()
        {
            return
                ...
                "html.launcher-transparent-overlay.mma-osu-focused,html.launcher-transparent-overlay.mma-osu-focused body,html.launcher-transparent-overlay.mma-osu-focused .main-card,html.launcher-transparent-overlay.mma-osu-focused .main-card *{cursor:none!important;}";
        }
        ...
        internal static string BuildCompanellaCss(double scale, string width)
        {
            return
                ...
                "html.mma-layout-companella .mma-comp-summary{grid-column:1!important;grid-row:3!important;display:grid!important;grid-template-columns:1.25fr repeat(5,minmax(0,1fr))!important;gap:" + Pixels(5, scale) + "!important;width:100%!important;min-width:0!important;}" +
                ...
                "html.mma-layout-companella .mma-comp-summary-dan .mma-comp-summary-value{overflow:visible!important;text-overflow:clip!important;white-space:normal!important;overflow-wrap:anywhere!important;word-break:break-word!important;}" +
                ...
                "html.mma-layout-companella .mma-comp-column{position:relative!important;display:grid!important;grid-template-rows:" + Pixels(116, scale) + " auto auto!important;align-content:start!important;gap:" + Pixels(4, scale) + "!important;height:auto!important;min-width:0!important;overflow:visible!important;}" +
                "html.mma-layout-companella .mma-comp-barbox{position:relative!important;display:flex!important;align-items:flex-end!important;width:100%!important;height:" + Pixels(116, scale) + "!important;background:rgba(43,46,57,.78)!important;border:" + Pixels(1, scale) + " solid rgba(255,255,255,.05)!important;border-radius:" + Pixels(3, scale) + "!important;overflow:visible!important;}" +
                "html.mma-layout-companella .mma-comp-bar{position:relative!important;display:block!important;width:100%!important;height:var(--mma-value,2%)!important;min-height:" + Pixels(2, scale) + "!important;overflow:visible!important;background:var(--mma-color,#69ced1)!important;border-radius:" + Pixels(3, scale) + " " + Pixels(3, scale) + " 0 0!important;}" +
                ...
                "html.mma-layout-companella .mma-comp-number{position:absolute!important;z-index:2!important;top:" + Pixels(3, scale) + "!important;left:50%!important;transform:translateX(-50%)!important;display:block!important;box-sizing:border-box!important;min-width:0!important;max-width:calc(100% - " + Pixels(4, scale) + ")!important;padding:" + Pixels(1, scale) + " " + Pixels(3, scale) + "!important;border:" + Pixels(1, scale) + " solid rgba(6,8,12,.70)!important;border-radius:" + Pixels(3, scale) + "!important;text-align:center!important;color:#ffffff!important;background:rgba(6,8,12,.80)!important;font-family:'Segoe UI',sans-serif!important;font-size:" + Pixels(8, scale) + "!important;font-weight:700!important;line-height:1.15!important;white-space:nowrap!important;overflow:hidden!important;text-overflow:ellipsis!important;pointer-events:none!important;text-shadow:0 " + Pixels(1, scale) + " " + Pixels(2, scale) + " rgba(0,0,0,.72)!important;}" +
                "html.mma-layout-companella .mma-comp-number.mma-comp-number-outside{top:auto!important;bottom:calc(100% + " + Pixels(3, scale) + ")!important;background:rgba(8,10,16,.95)!important;border-color:rgba(255,255,255,.28)!important;}" +
                "html.mma-layout-companella .mma-comp-detail{grid-row:3!important;display:-webkit-box!important;min-width:0!important;text-align:center!important;color:#b9bdca!important;font-family:'Segoe UI',sans-serif!important;font-size:clamp(" + Pixels(8, scale) + ",var(--mma-type-small)," + Pixels(11, scale) + ")!important;font-weight:400!important;line-height:1.15!important;white-space:normal!important;overflow:hidden!important;overflow-wrap:anywhere!important;text-overflow:ellipsis!important;-webkit-box-orient:vertical!important;-webkit-line-clamp:2!important;}" +
