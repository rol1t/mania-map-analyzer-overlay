...
public sealed partial class AnalyzerEngineScriptBridge
{
    ...
    private string BuildBootstrapScript(string sessionId)
    {
        ...
        var configuration = new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["riceAlgorithmPath"] = manifest.DefaultRiceAlgorithmPath ?? string.Empty,
            ["riceAlgorithmExport"] = manifest.RiceAlgorithmExport ?? string.Empty,
            ["lnAlgorithmPath"] = manifest.DefaultLnAlgorithmPath ?? string.Empty,
            ["lnAlgorithmExport"] = manifest.LnAlgorithmExport ?? string.Empty,
